...
# Load model once
# dnn_net = cv2.dnn.readNetFromCaffe('dnn_models/deploy.prototxt.txt', 'dnn_models/res10_300x300_ssd_iter_140000.caffemodel')
# dnn_net.setPreferableBackend(cv2.dnn.DNN_BACKEND_DEFAULT)
# dnn_net.setPreferableTarget(cv2.dnn.DNN_TARGET_CPU)


# def detect_faces_dnn(frame):
#     if dnn_net.empty():
#         raise RuntimeError("DNN model failed to load.")
